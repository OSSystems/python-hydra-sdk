...
class ClientTestCase(unittest.TestCase):
    ...
    def test_can_create_client(self):
        c = Client(**self.data)
        self.assertEqual(c.publichost, 'http://localhost:9000')
        self.assertEqual(c.adminhost, 'http://localhost:9001')
    ...
    def test_request_with_token_authentication(self, request):
        ...
        request.assert_called_with(
            'GET', 'http://localhost:9001/clients', headers=headers)
    ...
    def test_can_instrospect_token(self, request):
        ...
        request.assert_called_with(
            'POST', 'http://localhost:9001/oauth2/introspect',
    ...
    def test_can_get_login_request(self, request):
        ...
        request.assert_called_with(
            'GET',
            'http://localhost:9001/oauth2/auth/requests/login/{}'
    ...
    def test_can_accept_login_request(self, request):
        ...
        request.assert_called_with(
            'PUT',
            'http://localhost:9001/oauth2/auth/requests/login/{}/accept'
            .format(self.challenge),
            headers={'Authorization': 'None None'},
            json=accept_config)
    ...
    def test_can_get_consent_request(self, request):
        ...
        request.assert_called_with(
            'GET',
            'http://localhost:9001/oauth2/auth/requests/consent/{}'
            .format(self.challenge),
            headers={'Authorization': 'None None'})
    ...
    def test_can_accept_consent_request(self, request):
        ...
        request.assert_called_with(
            'PUT',
            'http://localhost:9001/oauth2/auth/requests/consent/{}/accept'
            .format(self.challenge),
            headers={'Authorization': 'None None'},
            json=accept_config)
